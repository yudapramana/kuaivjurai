...
@section('_styles')
    ...
    <meta property="og:image" content="{{ asset('images/kua/slide-1.jpg') }}" />
    ...
    <meta name="twitter:image" content="{{ asset('images/kua/slide-1.jpg') }}" />
    <meta property="twitter:url" content="{{ URL::current() }}">

    <link rel="canonical" href="{{ URL::current() }}" />
    <link rel="alternate" hreflang="id-ID" href="{{ URL::current() }}" />
    <link rel="shortcut icon" type="image/png" href="{{ asset('images/kua/slide-1.jpg') }}" />

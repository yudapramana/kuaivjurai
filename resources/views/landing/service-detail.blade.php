...
@section('_styles')
    ...
    <meta name="title" content="KUA IV Jurai - {{ $service->name }}">
    ...
    <meta property="og:title" content="KUA IV Jurai - {{ $service->name }} ">
    ...
    <meta property="twitter:title" content="KUA IV Jurai - {{ $service->name }}">
